...
//displaying all items received. tables users and orders
...
//tables: ordered items and items
        }
        Promise.all(promises)           //appending order details against respective order id
          .then(values => {
            for (let i = 0; i < items.length; i++) {
...
//To update ready value in orders table
  ...
  // Sending SMS to Customer when order will be ready
...
//To update picked at time on orders table
